...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-sm py-4">
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <div className="relative">
            <input 
              ...
              className="w-64 px-4 py-2 pr-10 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-localazy-teal/50"
            />
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-lg py-4 px-6 border-t border-gray-100 animate-fade-in">
          <div className="mb-4">
            <div className="relative">
              <input 
                type="text" 
                placeholder="Search for stores or products" 
                className="w-full px-4 py-2 pr-10 rounded-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-localazy-teal/50"
              />
              <Search className="absolute right-3 top-2.5 h-5 w-5 text-gray-400" />
            </div>
          </div>
